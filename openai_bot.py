...
async def welcome(message: types.Message):
    """A handler receives messages with `/start` command

    Args:
        message (types.Message): _description_
    """
    await message.reply("Hi,\nI'm a ChatBot created by Manirathinam!\nHow can I Assit you?")
...
async def help(message: types.Message):
    ...
    """
    help_command= """
    Hi There, I'm a bot created by Manirathinam! Please follow these commands - 
